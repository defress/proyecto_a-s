...
/*==========CONSULTA RETIRO DE ALUMNOS X ID APODERADO ================  */

DELIMITER $$
CREATE PROCEDURE SP_RETIROXID(
	IN _FK_ID_APOD INT
)
BEGIN
		SELECT 	DATE_FORMAT(R.FECHA,'%d-%m-%Y') AS 'Fecha', -- EXTRAEMOS SOLO DIA/MES/AÑO
        ...
        WHERE R.FK_ID_APOD = _FK_ID_APOD;			
END
$$
